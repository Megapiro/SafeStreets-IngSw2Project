\section[Architectural Design]{\hyperlink{toc}{Architectural Design}}
	...
	\subsection[Component Interfaces]{\hyperlink{toc}{Component Interfaces}}
		...
		% todo qui ci va una bella introduzione per sto diagramma, almeno dire come mai basta che lasciamo il diagramma senza dare neanche una descrizione dei metodi
		
		\newpage
		
		\begin{figure}[hbtp]
			\centering
			\includegraphics[scale=0.33, angle=90]{componentInterfaces.png}
