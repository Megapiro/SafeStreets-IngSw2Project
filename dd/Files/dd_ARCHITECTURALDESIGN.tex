\section[Architectural Design]{\hyperlink{toc}{Architectural Design}}
	...
	\subsection[Runtime View]{\hyperlink{toc}{Runtime View}}
		...
		The \emph{Runtime View Diagrams} of this section are presented first for the \textbf{users} and \textbf{authorities}, then for the common functionalities and lastly two critical views are shown in order to present how the components related to the safety calculus work in order to provide this functionality.
