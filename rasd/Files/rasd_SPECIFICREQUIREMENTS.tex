...
\subsection[External Interface Requirements]{\hyperlink{toc}{External Interface Requirements}}
	...
	\begin{figure}[h]
		...
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=0.45\textwidth]{/mockups/login.png}
			\caption{Login Interface}
		\end{minipage}\hfill
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=0.45\textwidth]{/mockups/userRegistration.png}
	...
	\begin{figure}[h]
		...
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=0.45\textwidth]{/mockups/authorityRegistration.png}
			\caption{Register Authority Interface}
		\end{minipage}\hfill
		\begin{minipage}{0.5\textwidth}
			\centering
			\includegraphics[width=0.45\textwidth]{/mockups/userHome.png}
...
\subsection[Functional Requirements]{\hyperlink{toc}{Functional Requirements}}
	...
	\subsubsection[Goals]{\hyperlink{toc}{Goals}}
		...
		\begin{description}
			...
			\item \ref{goal:notification}\ \textbf{Users should be able to notify authorities when traffic violations occur, in particular parking violations.}
				\begin{description}
					...
					\item \ref{dom:italyMaps}\ Maps of Italy are well known, complete and up to date.
			...
			\item \ref{goal:mining}\ \textbf{Users and authorities should be able to mine the information stored by SafeStreets, with different levels of visibility.}
				\begin{description}
					\setlength\itemsep{0.7cm}
					\item \ref{goal:miningA}\ \textbf{Users and authorities should be able to know where the highest number of violations occur.}
						\begin{description}
							\item \ref{req:userReg}\ The system must allow users to register.
							\item \ref{req:authorityReg}\ The system must allow authorities to register.
							\item \ref{req:userLogin}\ The system must allow the user to log in.
							...
							\item \ref{dom:streetCity}\ Every street belongs exactly to one city.
						\end{description}
					\item \ref{goal:miningB}\ \textbf{Users and authorities should be able to know what types of vehicle make the most violations.}
						\begin{description}
							\item \ref{req:userReg}\ The system must allow users to register.
							\item \ref{req:authorityReg}\ The system must allow authorities to register.
							\item \ref{req:userLogin}\ The system must allow the user to log in.
							...
							\item \ref{dom:streetCity}\ Every street belongs exactly to one city.
						\end{description}
					\item \ref{goal:miningC}\ \textbf{Authorities should be able to consult every violation report sent by users.}
						\begin{description}
							\item \ref{req:authorityReg}\ The system must allow authorities to register.
							\item \ref{req:authorityLogin}\ The system must allow authorities to log in.
							\item \ref{req:saveRegData}\ The system must save the customers registration data.
						...
						\end{description}
				\end{description}
			\item \ref{goal:safety}\ \textbf{Users should be able to know which streets are safe and which ones are not.} 
				\begin{description}
					\item \ref{req:userReg}\ The system must allow users to register.
					\item \ref{req:authorityReg}\ The system must allow authorities to register.
					\item \ref{req:userLogin}\ The system must allow the user to log in.
					...
					\item \ref{req:cityStreets} The system must be able to access all the available maps.
				...
				\end{description}	
			\item \ref{goal:intervention}\ \textbf{Users and authorities should be able to know the possible interventions that could be done in a city.}
				\begin{description}
					\item \ref{req:userReg}\ The system must allow users to register.
					\item \ref{req:authorityReg}\ The system must allow authorities to register.
					\item \ref{req:userLogin}\ The system must allow the user to log in.
	...
	\subsubsection[Use Cases Description]{\hyperlink{toc}{Use Cases Description}}
		...
		\begin{enumerate}
			...
			\item \textbf{Report Violation}
				...
				\begin{figure}[h]
					\centering 
					\includegraphics[scale=0.2, angle=90]{/diagrams/sequence/reportViolation.png}
			...
			\item \textbf{Find streets with the highest number of violations}
				...
				\begin{figure}[h]
					\centering
					\includegraphics[scale=0.26]{/diagrams/sequence/highestViolations.png}
			...
			\item \textbf{Find Most Dangerous Vehicles}
				...
				\begin{figure}[h]
					\centering
					\includegraphics[scale=0.23]{/diagrams/sequence/dangerousVehicles.png}
			...
			\item \textbf{Find Urgent Interventions}
				...
				\begin{figure}[hbtp]
					\centering
					\includegraphics[scale=0.26]{/diagrams/sequence/urgentInterventions.png}
		...
		\begin{figure}[h]
			\centering
			\includegraphics[scale=0.26, angle=90]{/diagrams/sequence/unsafeStreets.png}
		...
		\begin{enumerate}
			...
			\item \textbf{Check Unread Reports}
				...
				\begin{figure}[h]
					\centering
					\includegraphics[scale=0.25]{/diagrams/sequence/unreadReports.png}
			...
			\item \textbf{Find Reports}
				...
				\begin{figure}[hbtp]
					\centering
					\includegraphics[scale=0.25]{/diagrams/sequence/findReports.png}
