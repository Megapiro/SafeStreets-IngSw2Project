\section[Formal Analysis Using Alloy]{\hyperlink{toc}{Formal Analysis Using Alloy}}
	...
	%descrizione mondo
	In this first world (\blueAutoref{fig:firstWorld}), the focus is on the registration and on the map structure. 
